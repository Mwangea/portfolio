...
const Modal = ({activeID, setShowModal}) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
     <div className="max-w-[400px] absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform
     ...
     right-[1.7rem] text-[25px] flex items-center justify-center rounded -[3px] leading-0 cursor-pointer">&times;</button>
   </div>
   </div>
  )
}
